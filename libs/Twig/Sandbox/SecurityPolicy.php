...
class Twig_Sandbox_SecurityPolicy implements Twig_Sandbox_SecurityPolicyInterface {
    ...
    public function __construct(array $allowedTags = array(), array $allowedFilters = array(), array $allowedMethods = array(),
                                array $allowedProperties = array(), array $allowedFunctions = array()) {
    ...
    public function checkMethodAllowed($obj, $method) {
        ...
        if(!$allowed) {
            throw new Twig_Sandbox_SecurityError(sprintf('Calling "%s" method on a "%s" object is not allowed.', $method,
                                                         get_class($obj)));
        }
    }
    ...
    public function checkPropertyAllowed($obj, $property) {
        ...
        if(!$allowed) {
            throw new Twig_Sandbox_SecurityError(sprintf('Calling "%s" property on a "%s" object is not allowed.', $property,
                                                         get_class($obj)));
        }
    }
}
