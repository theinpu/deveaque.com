...
abstract class Twig_Template implements Twig_TemplateInterface {
     ...
     */
    protected function getAttribute($object, $item, array $arguments = array(), $type = Twig_TemplateInterface::ANY_CALL,
        ...
        if(Twig_TemplateInterface::METHOD_CALL !== $type) {
            ...
            if(Twig_TemplateInterface::ARRAY_CALL === $type) {
                ...
                if(is_object($object)) {
                    ...
                    throw new Twig_Error_Runtime(sprintf('Key "%s" for array with keys "%s" does not exist', $item,
        ...
        if(!is_object($object)) {
            ...
            throw new Twig_Error_Runtime(sprintf('Item "%s" for "%s" does not exist', $item,
                                                 is_array($object) ? 'Array' : $object));
        }
